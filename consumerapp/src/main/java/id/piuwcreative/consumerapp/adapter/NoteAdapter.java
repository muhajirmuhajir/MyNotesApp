package id.piuwcreative.consumerapp.adapter;
...
import id.piuwcreative.consumerapp.CustomOnItemClickListener;
import id.piuwcreative.consumerapp.NoteAddUpdateActivity;
import id.piuwcreative.consumerapp.R;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    public void removeItem(int position) {
        ...
        notifyItemRangeChanged(position, listNotes.size() -1);
    }
